...
/**
 * This is the item provider adapter for a {@link calculus.Opposite} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OppositeItemProvider 
	...
	protected void addOpPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnaryExpression_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnaryExpression_op_feature", "_UI_UnaryExpression_type"),
				 CalculusPackage.Literals.UNARY_EXPRESSION__OP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Opposite)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Opposite_type") :
			getString("_UI_Opposite_type") + " " + label;
	}
