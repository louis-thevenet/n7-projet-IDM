...
/**
 * This is the item provider adapter for a {@link calculusv2.InputArgs} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputArgsItemProvider 
	 ...
	 * @generated
	 */
	public InputArgsItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InputArgs"));
	}
	...
	public String getText(Object object) {
		String label = ((InputArgs)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_InputArgs_type") :
			getString("_UI_InputArgs_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InputArgs.class)) {
