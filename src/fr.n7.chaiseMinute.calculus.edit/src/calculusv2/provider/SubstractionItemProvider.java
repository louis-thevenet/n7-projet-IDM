...
/**
 * This is the item provider adapter for a {@link calculusv2.Substraction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubstractionItemProvider 
	...
	/**
	 * This adds a property descriptor for the Before Second feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBeforeSecondPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryOperation_beforeSecond_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryOperation_beforeSecond_feature", "_UI_BinaryOperation_type"),
				 Calculusv2Package.Literals.BINARY_OPERATION__BEFORE_SECOND,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Substraction_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Substraction.class)) {
