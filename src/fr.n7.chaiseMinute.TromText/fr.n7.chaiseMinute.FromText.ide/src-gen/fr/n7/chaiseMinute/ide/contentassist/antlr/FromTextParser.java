...
public class FromTextParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, FromTextGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAlgorithmAccess().getGroup_2_1(), "rule__Algorithm__Group_2_1__0");
			...
			builder.put(grammarAccess.getFunctionAccess().getGroup_5_3(), "rule__Function__Group_5_3__0");
			...
			builder.put(grammarAccess.getChaiseMinuteAccess().getTablesAssignment_1_1(), "rule__ChaiseMinute__TablesAssignment_1_1");
			...
			builder.put(grammarAccess.getComputedColumnAccess().getFunctionAssignment_5(), "rule__ComputedColumn__FunctionAssignment_5");
			...
			builder.put(grammarAccess.getAlgorithmAccess().getInputAssignment_0(), "rule__Algorithm__InputAssignment_0");
			builder.put(grammarAccess.getAlgorithmAccess().getInputAssignment_2_0(), "rule__Algorithm__InputAssignment_2_0");
			builder.put(grammarAccess.getAlgorithmAccess().getInputAssignment_2_1_1(), "rule__Algorithm__InputAssignment_2_1_1");
			builder.put(grammarAccess.getAlgorithmAccess().getFunctionAssignment_3(), "rule__Algorithm__FunctionAssignment_3");
			builder.put(grammarAccess.getFunctionAccess().getPreviousAssignment_3_1(), "rule__Function__PreviousAssignment_3_1");
			builder.put(grammarAccess.getFunctionAccess().getNextAssignment_4_1(), "rule__Function__NextAssignment_4_1");
			builder.put(grammarAccess.getFunctionAccess().getInputAssignment_5_2(), "rule__Function__InputAssignment_5_2");
			builder.put(grammarAccess.getFunctionAccess().getInputAssignment_5_3_1(), "rule__Function__InputAssignment_5_3_1");
			builder.put(grammarAccess.getFunctionAccess().getOperationAssignment_6_1(), "rule__Function__OperationAssignment_6_1");
		}
	}
