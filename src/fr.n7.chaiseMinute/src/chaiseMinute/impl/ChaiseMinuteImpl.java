...
public class ChaiseMinuteImpl extends MinimalEObjectImpl.Container implements ChaiseMinute {
		...
		if (tables != null && tables.eIsProxy()) {
			...
			if (tables != oldTables) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ChaiseMinutePackage.CHAISE_MINUTE__TABLES, oldTables, tables));
			}
		}
		return tables;
	}
	...
	public void setTables(Table newTables) {
		...
		tables = newTables;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChaiseMinutePackage.CHAISE_MINUTE__TABLES, oldTables, tables));
	}
