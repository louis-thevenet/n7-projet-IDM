...
/**
 * This is the item provider adapter for a {@link algorithm.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionItemProvider 
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Function_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Function_next_feature", "_UI_Function_type"),
				 AlgorithmPackage.Literals.FUNCTION__NEXT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AlgorithmPackage.Literals.FUNCTION__INPUT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AlgorithmPackage.Literals.FUNCTION__OPERATION);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(AlgorithmPackage.Literals.FUNCTION__OPERATION,
				 AlgorithmFactory.eINSTANCE.createSum()));
	}
