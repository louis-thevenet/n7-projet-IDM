...
/**
 * This is the item provider adapter for a {@link Column.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColumnItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ColumnPackage.Literals.COLUMN__CELLS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ColumnPackage.Literals.COLUMN__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Column)object).getId();
