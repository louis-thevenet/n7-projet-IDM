...
public class TabouretSecondeSyntacticSequencer extends AbstractSyntacticSequencer {

	protected TabouretSecondeGrammarAccess grammarAccess;
	protected AbstractElementAlias match_ChaiseMinute_CommaKeyword_2_1_0_q;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (TabouretSecondeGrammarAccess) access;
