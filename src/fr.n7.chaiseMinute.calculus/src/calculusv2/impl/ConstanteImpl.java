...
public class ConstanteImpl extends MinimalEObjectImpl.Container implements Constante {
	...
	protected EClass eStaticClass() {
		return Calculusv2Package.Literals.CONSTANTE;
	}
	...
	public Calculus getCalculus() {
		if (eContainerFeatureID() != Calculusv2Package.CONSTANTE__CALCULUS) return null;
	...
	public NotificationChain basicSetCalculus(Calculus newCalculus, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newCalculus, Calculusv2Package.CONSTANTE__CALCULUS, msgs);
		return msgs;
	}
	...
	public void setCalculus(Calculus newCalculus) {
		if (newCalculus != eInternalContainer() || (eContainerFeatureID() != Calculusv2Package.CONSTANTE__CALCULUS && newCalculus != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Calculusv2Package.CONSTANTE__CALCULUS, newCalculus, newCalculus));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Calculusv2Package.CONSTANTE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Calculusv2Package.CONSTANTE__CALCULUS:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
