 ...
 *   <li>{@link calculusv2.impl.ProductsImpl#getBefore <em>Before</em>}</li>
...
public class ProductsImpl extends MinimalEObjectImpl.Container implements Products {
	...
	public EList<PipeSuper> getUsedBy() {
		if (usedBy == null) {
			usedBy = new EObjectWithInverseResolvingEList<PipeSuper>(PipeSuper.class, this, Calculusv2Package.PRODUCTS__USED_BY, Calculusv2Package.PIPE_SUPER__SOURCE_PIPE);
		}
		return usedBy;
	}
	...
	public Pipe getBefore() {
		if (before != null && before.eIsProxy()) {
			...
			if (before != oldBefore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Calculusv2Package.PRODUCTS__BEFORE, oldBefore, before));
			}
		}
		return before;
	}
