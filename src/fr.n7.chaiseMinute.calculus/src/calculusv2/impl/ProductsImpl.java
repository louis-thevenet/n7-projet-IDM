 ...
 * </p>
 * <ul>
 *   <li>{@link calculusv2.impl.ProductsImpl#getCalculus <em>Calculus</em>}</li>
 *   <li>{@link calculusv2.impl.ProductsImpl#getName <em>Name</em>}</li>
 *   <li>{@link calculusv2.impl.ProductsImpl#getUsedBy <em>Used By</em>}</li>
 *   <li>{@link calculusv2.impl.ProductsImpl#getBeforeFirst <em>Before First</em>}</li>
 *   <li>{@link calculusv2.impl.ProductsImpl#getBeforeSecond <em>Before Second</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductsImpl extends MinimalEObjectImpl.Container implements Products {
	...
	protected EClass eStaticClass() {
		return Calculusv2Package.Literals.PRODUCTS;
	}
	...
	public Calculus getCalculus() {
		if (eContainerFeatureID() != Calculusv2Package.PRODUCTS__CALCULUS) return null;
	...
	public NotificationChain basicSetCalculus(Calculus newCalculus, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newCalculus, Calculusv2Package.PRODUCTS__CALCULUS, msgs);
		return msgs;
	}
	...
	public void setCalculus(Calculus newCalculus) {
		if (newCalculus != eInternalContainer() || (eContainerFeatureID() != Calculusv2Package.PRODUCTS__CALCULUS && newCalculus != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Calculusv2Package.PRODUCTS__CALCULUS, newCalculus, newCalculus));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Calculusv2Package.PRODUCTS__NAME, oldName, name));
	}
	...
	public Pipe getBeforeFirst() {
		if (beforeFirst != null && beforeFirst.eIsProxy()) {
			...
			if (beforeFirst != oldBeforeFirst) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Calculusv2Package.PRODUCTS__BEFORE_FIRST, oldBeforeFirst, beforeFirst));
			}
		}
		return beforeFirst;
	}
	...
	public void setBeforeFirst(Pipe newBeforeFirst) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Calculusv2Package.PRODUCTS__BEFORE_FIRST, oldBeforeFirst, beforeFirst));
	}
	...
	public Pipe getBeforeSecond() {
		if (beforeSecond != null && beforeSecond.eIsProxy()) {
			...
			if (beforeSecond != oldBeforeSecond) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Calculusv2Package.PRODUCTS__BEFORE_SECOND, oldBeforeSecond, beforeSecond));
			}
		}
		return beforeSecond;
	}
	...
	public void setBeforeSecond(Pipe newBeforeSecond) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Calculusv2Package.PRODUCTS__BEFORE_SECOND, oldBeforeSecond, beforeSecond));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Calculusv2Package.PRODUCTS__CALCULUS:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Calculusv2Package.PRODUCTS__CALCULUS:
				return getCalculus();
			case Calculusv2Package.PRODUCTS__NAME:
				return getName();
			case Calculusv2Package.PRODUCTS__USED_BY:
				return getUsedBy();
			case Calculusv2Package.PRODUCTS__BEFORE_FIRST:
				if (resolve) return getBeforeFirst();
				return basicGetBeforeFirst();
			case Calculusv2Package.PRODUCTS__BEFORE_SECOND:
