 ...
 *   <li>{@link calculusv2.impl.SubstractionImpl#getBefore <em>Before</em>}</li>
...
public class SubstractionImpl extends MinimalEObjectImpl.Container implements Substraction {
	...
	public EList<PipeSuper> getUsedBy() {
		if (usedBy == null) {
			usedBy = new EObjectWithInverseResolvingEList<PipeSuper>(PipeSuper.class, this, Calculusv2Package.SUBSTRACTION__USED_BY, Calculusv2Package.PIPE_SUPER__SOURCE_PIPE);
		}
		return usedBy;
	}
	...
	public Pipe getBefore() {
		if (before != null && before.eIsProxy()) {
			...
			if (before != oldBefore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Calculusv2Package.SUBSTRACTION__BEFORE, oldBefore, before));
			}
		}
		return before;
	}
	...
	public NotificationChain basicSetBefore(Pipe newBefore, NotificationChain msgs) {
		...
		before = newBefore;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Calculusv2Package.SUBSTRACTION__BEFORE, oldBefore, newBefore);
	...
	public void setBefore(Pipe newBefore) {
		if (newBefore != before) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Calculusv2Package.SUBSTRACTION__BEFORE, newBefore, newBefore));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case Calculusv2Package.SUBSTRACTION__BEFORE:
				if (before != null)
					msgs = ((InternalEObject)before).eInverseRemove(this, Calculusv2Package.PIPE__TARGET_PIPE, Pipe.class, msgs);
