...
public class InverseImpl extends MinimalEObjectImpl.Container implements Inverse {
	...
	protected EClass eStaticClass() {
		return CalculusPackage.Literals.INVERSE;
	}
		...
		if (input != null && input.eIsProxy()) {
			...
			if (input != oldInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CalculusPackage.INVERSE__INPUT, oldInput, input));
			}
		}
		return input;
	}
	...
	public void setInput(Expression newInput) {
		...
		input = newInput;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CalculusPackage.INVERSE__INPUT, oldInput, input));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CalculusPackage.INVERSE__NAME, oldName, name));
	}
	...
	public void setOp(String newOp) {
		...
		op = newOp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CalculusPackage.INVERSE__OP, oldOp, op));
	}
