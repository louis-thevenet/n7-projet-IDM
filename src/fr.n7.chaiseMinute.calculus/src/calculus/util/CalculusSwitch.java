 ...
 * @generated
 */
public class CalculusSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CalculusPackage.CALCULUS: {
				Calculus calculus = (Calculus)theEObject;
				T result = caseCalculus(calculus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculusPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculusPackage.INPUTS_ARGS: {
				InputsArgs inputsArgs = (InputsArgs)theEObject;
				T result = caseInputsArgs(inputsArgs);
				if (result == null) result = caseExpression(inputsArgs);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculusPackage.UNARY_EXPRESSION: {
			...
			case CalculusPackage.INVERSE: {
				Inverse inverse = (Inverse)theEObject;
				T result = caseInverse(inverse);
				if (result == null) result = caseUnaryExpression(inverse);
				if (result == null) result = caseExpression(inverse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculusPackage.OPPOSITE: {
				Opposite opposite = (Opposite)theEObject;
				T result = caseOpposite(opposite);
				if (result == null) result = caseUnaryExpression(opposite);
				if (result == null) result = caseExpression(opposite);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculusPackage.BINARY_EXPRESSION: {
			...
			case CalculusPackage.SUM: {
				Sum sum = (Sum)theEObject;
				T result = caseSum(sum);
				if (result == null) result = caseBinaryExpression(sum);
				if (result == null) result = caseExpression(sum);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculusPackage.SUBSTRACTION: {
				Substraction substraction = (Substraction)theEObject;
				T result = caseSubstraction(substraction);
				if (result == null) result = caseBinaryExpression(substraction);
				if (result == null) result = caseExpression(substraction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculusPackage.PRODUCTS: {
				Products products = (Products)theEObject;
				T result = caseProducts(products);
				if (result == null) result = caseBinaryExpression(products);
				if (result == null) result = caseExpression(products);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculusPackage.DIVISION: {
			...
			case CalculusPackage.CONSTANTE: {
			...
			case CalculusPackage.FINALE_EXPRESSION: {
				FinaleExpression finaleExpression = (FinaleExpression)theEObject;
				T result = caseFinaleExpression(finaleExpression);
				if (result == null) result = caseExpression(finaleExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculusPackage.RESULT: {
				Result result = (Result)theEObject;
				T theResult = caseResult(result);
				if (theResult == null) theResult = caseFinaleExpression(result);
				if (theResult == null) theResult = caseExpression(result);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Inputs Args</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Inputs Args</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInputsArgs(InputsArgs object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Finale Expression</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Finale Expression</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFinaleExpression(FinaleExpression object) {
		return null;
	}
