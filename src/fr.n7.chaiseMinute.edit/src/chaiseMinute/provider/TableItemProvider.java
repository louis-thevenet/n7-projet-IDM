...
/**
 * This is the item provider adapter for a {@link chaiseMinute.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChaiseMinutePackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ChaiseMinutePackage.Literals.TABLE__COLUMNS,
				 ChaiseMinuteFactory.eINSTANCE.createColumnData()));

		newChildDescriptors.add
			(createChildParameter
				(ChaiseMinutePackage.Literals.TABLE__COLUMNS,
				 ChaiseMinuteFactory.eINSTANCE.createComputedColumn()));

		newChildDescriptors.add
			(createChildParameter
				(ChaiseMinutePackage.Literals.TABLE__COLUMNS,
				 ChaiseMinuteFactory.eINSTANCE.createImportedColumn()));
